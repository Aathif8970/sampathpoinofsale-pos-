...
public class Adminlogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String txtaname=txtname.getText();
        String txtapassword=txtpassword.getText();
        ...
        try{
            ...
            String query = "select Admin_id, Admin_password from adminlogin where Admin_id=? and Admin_password=?";
            pst=con.prepareStatement(query);
            pst.setString(1,  txtaname);
            pst.setString(2, txtapassword);
